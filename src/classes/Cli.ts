          ...
          for (let i = 0; i < this.vehicles.length; i++) {
            if (this.vehicles[i].vin === this.selectedVehicleVin) {
              if (this.vehicles[i] instanceof Truck) {
                ...
                console.log("Only trucks can tow vehicles. Please select a truck to perform this action.");
                break;
              }
            }
          }
          ...
          for (let i = 0; i < this.vehicles.length; i++) {
            if (this.vehicles[i].vin === this.selectedVehicleVin) {
              if (this.vehicles[i] instanceof Motorbike) {
                ...
                console.log("Only motorbikes can perform wheelies. Please select a motorbike to perform this action.");
                this.performActions();
